...
class MainMenu(Frame):
	...
	def draw_menu(self):
		...
		check_debug = Checkbutton(self, text="DEBUG", variable=self.controller.debug, command=self.check_clicked)
